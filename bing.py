...
openai.api_key = "[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]"
...
async def main():
    while True:
        ...
        with sr.Microphone() as source:
            ...
            print(f"Waiting for wake words 'ok bing' or 'ok google'...")
            while True:
            ...
            if wake_word == BING_WAKE_WORD:
                bot = Chatbot(kie_path='cookies.json')
